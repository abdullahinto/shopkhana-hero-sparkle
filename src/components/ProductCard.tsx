    ...
    >
      <CardContent className="p-0">
        ...
        <div className="relative overflow-hidden aspect-square">
          ...
          {/* New Badge */}
          {product.isNew && (
            <Badge className="absolute top-2 left-2 bg-shopkhana-yellow text-shopkhana-black font-semibold">
              NEW
            </Badge>
          )}
          ...
          <Button
            ...
            className={`absolute top-2 right-2 h-8 w-8 rounded-full bg-white/80 backdrop-blur-sm hover:bg-white transition-all duration-200 ${
          ...
          {/* Quick Add to Cart - Mobile and Desktop */}
          <div 
          ...
          >
            <Button 
              size="sm"
              className="w-full bg-shopkhana-yellow text-shopkhana-black hover:bg-shopkhana-yellow/90 font-semibold shadow-lg"
            >
        ...
        <div className="p-3 space-y-2">
          ...
          <div className="flex items-center justify-between">
            <p className="font-poppins font-bold text-lg text-shopkhana-black">
